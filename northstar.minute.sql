...
--
-- SOL-NATIVE COLLECTION
-- $1 = inclusive window start (UTC timestamptz)
-- $2 = exclusive window end (UTC timestamptz)
--
-- Run ONLY through the checkpointed worker.
-- The worker owns BEGIN / COMMIT / ROLLBACK.
--
-- USD POLICY:
--   latest_market_cap_usd = NULL
--   latest_sol_price_usd  = NULL
-- No SOL-to-USD conversion or inferred USD valuation.
--
-- WARNING:
